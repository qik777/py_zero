...
cv2.imwrite(path+'lanka_elephant.jpg', img_elephant)
...
cv2.imwrite(path+'lanka_safari_sheared.jpg', img_sheared)
...
cv2.imwrite(path+'lanka_safari_rotated.jpg', img_rotated)
...
cv2.imwrite(path+'lanka_safari_transformed.jpg', img_transformed)